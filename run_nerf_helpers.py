...
def mse2psnr(x): return -10.*tf.math.log(x)/tf.math.log(10.)  # Fix 1: tf.log removed in TF2
...
def init_nerf_model(D=8, W=256, input_ch=3, input_ch_views=3, output_ch=4, skips=[4], use_viewdirs=False):
    ...
    inputs = tf.keras.Input(shape=(input_ch + input_ch_views,))  # Fix 3: shape must be tuple in Keras3
